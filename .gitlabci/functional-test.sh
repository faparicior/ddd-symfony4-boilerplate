...
sed -i 's/SENTRY_DSN_/'$SENTRY_DSN'/g' /var/www/html/.env
sed -i 's/ROLLBAR_TOKEN_/'$ROLLBAR_TOKEN'/g' /var/www/html/.env
sed -i 's/LOGGY_TOKEN_/'$LOGGY_TOKEN'/g' /var/www/html/.env
